...
class Argparser(argparse.ArgumentParser):
    ...
    def arguments_common(self):
        ...
        group.add_argument('--loss_type', type=str, default=None, help='Desired loss function to use')
        group.add_argument('--num_labels', type=int, default=None, help='number of labels')
